...
class TableRequestModel(BaseModel):
    ...
    status_filter = fields.List(
        fields.Enum(ImageStatus, by_value=True), allow_none=True
    )
...
class ImageTableRequestModel(TableRequestModel):
    status_filters = fields.List(fields.Enum(ImageStatus), allow_none=True)
