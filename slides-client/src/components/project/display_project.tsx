...
export default function DisplayProject (): ReactElement {
    ...
    const setupSection: MenuSection = {
        name: 'Setup',
        items: [
            { name: 'Search', path: 'search', disabled: !projectIsSearchable(project) },
    ...
    const convertSection: MenuSection = {
        name: 'Export',
        items: [
            { name: 'Execute', path: 'execute', disabled: !projectIsStartable(project) },
            { name: 'Progress', path: 'progress', disabled: !projectIsConverting(project) },
            { name: 'Validate', path: 'validate', disabled: !projectIsConverting(project) },
            { name: 'Submit', path: 'submit', disabled: !projectIsCompleted(project) }
        ]
    }
    const sections = [
        projectSection,
    ...
    const routes = [
        ...
        (<Route key="settings" path="/settings" element={<Settings project={project} setProject={setProject} />} />),
        (<Route key="batches" path="/batches" element={<Batches project={project} />} />),
        (<Route key="search" path="/search" element={<Search project={project} nextView="curate" changeView={changeView} />} />),
        (<Route key="curate" path="/curate" element={project.uid !== '' && <Curate project={project} />} />),
        (<Route key="execute" path="/execute" element={project.uid !== '' && <Execute project={project} nextView="progress" changeView={changeView} />} />),
        (<Route key="progress" path="/progress" element={project.uid !== '' && <Progress project={project} />} />),
        (<Route key="validate" path="/validate" element={project.uid !== '' && <Validate project={project} />} />),
        (<Route key="submit" path="/submit" element={project.uid !== '' && <Submit project={project} />} />)
