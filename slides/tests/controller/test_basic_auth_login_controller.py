...
from slides.config import ConfigTest

import pytest
from flask import Flask

from slides.test_classes import TestAuthService
from slides.test_classes import TestLoginService
from slides.controller import BasicAuthLoginController
